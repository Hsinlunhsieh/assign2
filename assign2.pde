  ...
  switch (gameState){
    ...
    case GAME_RUN:
        ...
        if(life < 0){
         ...
         // car1 hitTest
         if ((leftCar1X < frogX && leftCar1X > frogX-32) && 
            (frogY > 96 && frogY < 160)){
             currentTime = millis();
         ...
         // car2 hitTest
         if ((rightCar1X > frogX && rightCar1X < frogX+32) && 
            (frogY > 160 && frogY < 224)){
             currentTime = millis();
             image(imgDeadFrog, frogX, frogY);
             life--;
         ...
         // car3 hitTest
         if ((leftCar2X < frogX && leftCar2X > frogX-32) && 
            (frogY > 224 && frogY < 288)){
             currentTime = millis();
             image(imgDeadFrog, frogX, frogY);
             life--;
         ...
         // car4 hitTest
         if ((rightCar2X > frogX && rightCar2X-32 < frogX) && 
            (frogY > 288 && frogY < 352)){
             currentTime = millis();
             image(imgDeadFrog, frogX, frogY);
             life--;
